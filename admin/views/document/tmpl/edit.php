...
<form enctype="multipart/form-data"
      action="<?php echo JRoute::_('index.php?option=com_firedrive&layout=edit&id=' . (int) $this->item->id); ?>"
      method="post" name="adminForm" id="document-form" class="form-validate">
                                ...
                                <div class="controls selected">
                                    <div class="input-append">
                                        ...
                                        <a target="_blank" class="btn btn-primary"
                                           href="<?php echo JUri::base() . "index.php?option=com_firedrive&task=download&id=" . $this->item->id; ?>"><i
