...
<form action="<?php echo JRoute::_('index.php?option=com_simplefilemanager&view=documents'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container" class="span10">
		...
		<?php else : ?>
					...
					<?php foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid; ?>">
							...
							<td class="small hidden-phone">
								<?php switch ($item->visibility) 
								{
									case 1: echo JText::_('COM_SIMPLEFILEMANAGER_VISIBILITY_1_PUBLIC'); break;
									case 2: echo JText::_('COM_SIMPLEFILEMANAGER_VISIBILITY_2_REGISTRED'); break;
									case 3: echo JText::_('COM_SIMPLEFILEMANAGER_VISIBILITY_3_USER'); break;
									case 4: echo JText::_('COM_SIMPLEFILEMANAGER_VISIBILITY_4_GROUP'); break;
									case 5: echo JText::_('COM_SIMPLEFILEMANAGER_VISIBILITY_5_AUTHOR'); break;
								} ?>
							</td>
							<td class="small hidden-phone">
			...
			<?php if ($user->authorise('core.create', 'com_simplefilemanager')
				&& $user->authorise('core.edit', 'com_simplefilemanager')
				&& $user->authorise('core.edit.state', 'com_simplefilemanager')) : ?>
				<?php echo JHtml::_(
