...
<script type="text/javascript">
    ...
    jQuery(function(){
        jQuery('#jform1_uploader').change(function(){
            ...
            if (<?php echo $maxFileSize ?> < s) alert("<?php echo JText::sprintf('COM_SIMPLEFILEMANAGER_UPLOAD_MAX_SIZE_EXCEEDED_ERROR', $maxFileSize/1048576 ); ?>");
        })
    })
...
>
	...
	<div class="form-horizontal">
                    ...
                    <div class="span6">
                        <div class="control-group">
                            ...
                            <div class="controls choose">
                                <input type="file" <?php if($isNew) echo 'class="required" aria-require="true" required="required"'; ?> id="jform1_uploader" name="jform1[test][]" />
                            </div>
                        </div>
                    </div>
                ...
                <script>
                    $(document).ready(function(){
                        $('#jform1_uploader').on('change',function(evt){
                            if(<?php echo SimplefilemanagerHelper::getMaxFileUploadSize(); ?> > this.files[0].size)
                            {
                                alert("casso!");
                            }
                        })
		...
		<?php /*echo JHtml::_('bootstrap.addTab', 'myTab', 'otherparams', JText::_('COM_SIMPLEFILEMANAGER_EDIT_LABEL_ADVANCED', true)); ?>
