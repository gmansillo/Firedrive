...
<form action="<?php echo JRoute::_('index.php?option=com_simplefilemanager&view=simplefilemanagers'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<?php endif;?>
		...
		<div id="filter-bar" class="js-stools-container-bar clearfix">
			<div class="filter-search btn-group pull-left">
				<label for="filter_search" class="element-invisible"><?php echo JText::_('COM_SIMPLEFILEMANAGER_SEARCH_IN_TITLE');?></label>
				<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('COM_SIMPLEFILEMANAGER_SEARCH_IN_TITLE'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_SIMPLEFILEMANAGER_SEARCH_IN_TITLE'); ?>" />
			</div>
				...
				?>
					...
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
						...
						<td class="has-context">
							...
							<?php endif; ?>
							<?php if ($canEdit) : ?>
								<a class="hasTooltip" href="<?php echo JRoute::_('index.php?option=com_simplefilemanager&task=simplefilemanager.edit&id=' . $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>"><?php echo $this->escape($item->title); ?></a>
							<?php else : ?>
...
<div id="importMassive" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<div class="modal-body">
			<?php if(count($this->massiveFileImportQueue)==0): ?>
		   	...
		   	<?php else: ?>
		   		<form class="text-center" method="post" action="<?php echo JRoute::_('index.php?option=com_simplefilemanager&view=simplefilemanagers&task=massiveImport'); ?>">
