<?php
    ...
    class SimplefilemanagerViewSimplefilemanagers extends JViewLegacy
    {
        ...
        {
            return array('a.ordering' => JText::_('JGRID_HEADING_ORDERING'), 'a.visibility' => JText::_('COM_SIMPLEFILEMANAGER_FIELD_VISIBILITY_LABEL'), 'a.file_created' => JText::_('COM_SIMPLEFILEMANAGER_HEADING_CREATED'), 'a.author' => JText::_('JAUTHOR'), 'a.download_counter' => JText::_('COM_SIMPLEFILEMANAGER_HEADING_HITS'), 'a.state' => JText::_('JSTATUS'), 'a.title' => JText::_('JGLOBAL_TITLE'), 'a.id' => JText::_('JGRID_HEADING_ID'));
        }
    }