...
<div class="simplefilemanager-edit front-end-edit">
    ...
    <form enctype="multipart/form-data" id="form-simplefilemanager"
		...
		<input type="hidden" name="jform[id]"
			...
			name="jform[ordering]" value="<?php echo $this->item->ordering; ?>" />
		...
		<fieldset>
			...
			<ul class="nav nav-tabs">
				<li class="active"><a href="#general" data-toggle="tab"><?php echo JText::_('COM_SIMPLEFILEMANAGER_DOCUMENT_GENERAL') ?></a></li>
				<li><a href="#publishing" data-toggle="tab"><?php echo JText::_('COM_SIMPLEFILEMANAGER_DOCUMENT_PUBLISHING') ?></a></li>
			</ul>
			...
			<div class="tab-content">
				...
				<div class="tab-pane" id="publishing">
					...
					<?php if ($this->item->id > 0): ?>
						...
						<div class="control-group">
							<div class="control-label"><?php echo JText::_('COM_SIMPLEFILEMANAGER_FIELD_FILESIZE_LABEL'); ?></div>
