...
<form class="simplefilamanager" action="<?php echo JRoute::_('index.php?option=com_simplefilemanager&view=simplefilemanagers'); ?>" method="post" name="adminForm" id="adminForm">
	    ...
	    <?php foreach ($this->items as $i => $item) : ?>
	        ...
	        <tr class="row<?php echo $i % 2; ?>">
	            ...
	            <?php endif; ?>
					...
					<?php if($this->showLicence): ?>
						<td>
							<?php if( $item->license_link ) echo '<a href="'.$item->license_link.'" target="_blank">'.$item->license.'</a>'; else echo $item->license;?>
						</td>
					<?php endif; ?>
			        ...
			        <?php endif; ?>
						...
						<?php if($item->canDownload): ?>
							...
							<?php else: ?>
								<a class="btn" href="<?php echo JRoute::_('index.php?option=com_simplefilemanager&view=download&id='.(int)$item->id); ?>">
	            	...
	            	<?php if ($canEdit || $canDelete): ?>
						<td class="center">
							<?php if ($canEdit): ?>
								<a href="<?php echo JRoute::_('index.php?option=com_simplefilemanager&task=simplefilemanagerform.edit&id=' . $item->id, false, 2); ?>" class="btn btn-mini" type="button"><i class="icon-edit" ></i></a>
							<?php endif; ?>
							<?php if ($canDelete): ?>
    ...
    <?php if ($canCreate): ?>
        <a href="<?php echo JRoute::_('index.php?option=com_simplefilemanager&task=simplefilemanagerform.edit&id=0', false, 2); ?>" class="btn btn-success btn-small">
